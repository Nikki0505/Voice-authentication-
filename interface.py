...
paths = {
    ...
    'opera': "C:\\Users\\singh\\AppData\\Local\\Programs\\Opera\\launcher.exe",
...
positive_response = ["Cool, I am on it mam!", " Okay mam, I'm working on it!", "Just a second sir!"]
...
email_id = "singhneelu055@gmail.com"
password = "vadnere1005"
...
def new_text_file():
    ...
    file = "C:\\Users\\singh\\OneDrive\\Desktop"+file_name + ".txt"
    f = open(file, "w+")
...
def greet():
    ...
    if 4 < current_time <= 12:
        ...
        speak("Hey swar and Good morning " + User_name + "!")
    elif 12 < current_time <= 16:
        speak("Hey swar and Good afternoon " + User_name + "!")
    elif 16 < current_time <= 21:
        speak("Hey swar and Good evening " + User_name + "!")
